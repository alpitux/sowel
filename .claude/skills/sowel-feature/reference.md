...
Sowel production runs on Linux VM `sowelox` at `192.168.0.230:3000` (public: ``). See [docs/technical/deployment.md](../../../docs/technical/deployment.md) for full operations guide.
